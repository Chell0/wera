...
const venues: Venue[] = [
    ...
    { Name: 'Afrotopia', Ansprechperson: 'Dr. Christian Kodzo Ayivi', Kontakt: 'info@afrotopia.de', Angebote: 'Innovation Space, Entrepreneurship & Co-Working Space, Social & Event Space, Learning Space - Afrotopia Black Academy', Website: 'Home - Afrotopia' },
    { Name: 'Ossara', Ansprechperson: 'Julia Karimi', Kontakt: 'info@ossara.de', Angebote: 'Beratungsangebote, Bildungsangebote zu Rassismus und Kolonialismus, Vernetzung, Lobbyarbeit', Website: 'Ossara e.V. - Verein für Bildung, Gesundheit und kulturelle Vielfalt' },
    ...
    { Name: 'W3_Werkstatt für internationale Kultur und Politik', Ansprechperson: 'Esther Yungsung Lisa Rüden          ', Kontakt: 'info@w3-hamburg.de', Angebote: 'Rassismuskritische und geschlechterreflektierende Prozessbegleitung, Empowerment-Workshops, Anti-Rassismus und kritisches weißsein, Gender Trainings, Akademie für Kinder- und Jugendparlamente, Politisch aktiv mit Kindern, Randale Zentrale-Politische Krabbelgruppe, [in:szene]+, VerCAREte Verhältnisse, Koloniale Spuren – Dekoloniale Praktiken', Website: 'W3 – Werkstatt für internationale Kultur und Politik (w3-hamburg.de)' },
    { Name: 'Fachpromotorin für dekoloniale Perspektiven - Schwerpunkt Vernetzung', Ansprechperson: 'Sonia Octavio', Kontakt: 'sonia.octavio@ossara.de ', Angebote: 'Vernetzung und Unterstützung von Akteur*innen der Dekolonisierungsszene', Website: 'Fachpromotor*innen Dekoloniale Perspektiven im entwicklungspolitischen Engagement - Verein für Bildung, Gesundheit und kulturelle Vielfalt (ossara.de)' },
    { Name: 'Fachpromotorin für dekoloniale Perspektiven  - Schwerpunkt Beratung', Ansprechperson: 'Catherine Schlüter', Kontakt: 'catherine.schlueter@ossara.de', Angebote: 'Beratung von zivilgesellschaftlichen Initiativen und Multiplikator*innen', Website: 'Fachpromotor*innen Dekoloniale Perspektiven im entwicklungspolitischen Engagement - Verein für Bildung, Gesundheit und kulturelle Vielfalt (ossara.de)' },
];
